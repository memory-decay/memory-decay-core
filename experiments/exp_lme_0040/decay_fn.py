"""Jost's Law decay with stretched exponential."""
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # --- Stretched exponential decay instead of Jost power law ---
    ...
    # Stretched exponential: a(t) = a0 * exp(-(lambda * t)^beta)
    # For discrete decay: new = old * exp(-lambda^beta)
    stretch_beta = params.get("stretch_beta", 0.7)

    decay_amount = effective_lambda * (excess ** stretch_beta)
