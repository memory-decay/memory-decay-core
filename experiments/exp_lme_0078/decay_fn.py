...
Same decay as exp_lme_0068.
Policy: retrieval_consolidation with TUNED test reactivation params.
Changed: test_reactivation_start_tick=40 (from 80), test_reactivation_interval=10 (from 20).
More frequent and earlier test memory reactivation.
"""
