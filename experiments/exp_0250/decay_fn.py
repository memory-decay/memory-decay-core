"""Quadratic approach impact scaling with convex floor."""
import math
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # Quadratic impact scaling — concentrates fast decay on low impact
    approach_rate = base_approach * (1.0 + approach_impact * (1.0 - impact) ** 2)
