...
Change: alpha=2.0 (from 1.5) — impact matters more relative to stability.
importance = (impact * alpha + stability * rho) / (alpha + rho)
Higher alpha means high-impact items get a higher importance score,
so their sigmoid floor is higher and they decay slower.
"""
