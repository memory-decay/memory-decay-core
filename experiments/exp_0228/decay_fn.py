"""Impact-dependent floor with constant approach rate for threshold discrimination."""
import math
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # Impact-dependent floor with sqrt scaling
    floor_min = params.get("floor_min", 0.15)
    ...
    if activation > consolidation_threshold:
        ...
        # Constant approach rate (not divided by combined) for faster convergence
        approach_rate = params.get("approach_rate", 0.03)
