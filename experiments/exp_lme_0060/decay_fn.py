...
Same as exp_lme_0059 — this passes strict validation.
Hypothesis for this run: increase reinforcement gains and activation_weight so that
recalled memories stay active longer, improving activation-recall correlation (was 0.27).
"""
