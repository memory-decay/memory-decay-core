"""Type-diff with slower approach and sqrt floor."""
import math
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    base_approach = params.get("base_approach", 0.004)
    approach_impact = params.get("approach_impact", 7.0)
    type_fact_factor = params.get("type_fact_factor", 0.8)
