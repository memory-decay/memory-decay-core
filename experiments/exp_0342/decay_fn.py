"""Jost decay with memory-type-specific curvature."""
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    jost_power_fact = params.get("jost_power_fact", 4.2)
    jost_power_episode = params.get("jost_power_episode", 3.4)
    jost_power = jost_power_fact if mtype == "fact" else jost_power_episode
