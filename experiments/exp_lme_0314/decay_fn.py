...
Follow-up to exp_lme_0234 with distance-from-floor modulation.
Hypothesis: Stronger stability effect — decay rate is modulated by distance from floor.
When activation is far above floor → faster decay. When near floor → slower decay.
"""
