"""Consolidation + impact-dependent approach rate."""
import math
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    if activation > consolidation_threshold:
        ...
        # Impact-dependent approach rate
        base_approach = params.get("base_approach", 0.01)
        approach_impact = params.get("approach_impact", 3.0)
        approach_rate = base_approach * (1.0 + approach_impact * (1.0 - impact))
