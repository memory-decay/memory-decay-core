"""Jost's Law decay with logarithmic saturation floor."""
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # --- Floor: logarithmic saturation of importance ---
    ...
    # Logarithmic saturation instead of sigmoid
    log_k = params.get("log_k", 3.0)
    sigmoid_floor = math.log(1 + log_k * importance) / math.log(1 + log_k)

    floor = floor_max * sigmoid_floor
