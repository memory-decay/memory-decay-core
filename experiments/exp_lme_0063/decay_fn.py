...
Same as exp_lme_0059 (passes strict validation).
Changes:
- jost_power: 4.0 -> 5.0 (faster decay in the floor regime, excess^5 is much smaller)
- floor_max: 0.45 -> 0.40 (slightly lower floor for all non-zero-impact items)

Hypothesis: faster Jost decay (power 5) + lower floor will improve recall precision
by making moderate-impact items decay faster, sharpening selectivity.
"""
