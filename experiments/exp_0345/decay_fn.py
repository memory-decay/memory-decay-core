"""Jost decay with nonlinear retention weighting."""
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    impact_power = params.get("impact_power", 1.35)
    stability_power = params.get("stability_power", 1.15)
    impact_term = impact ** impact_power
    stability_term = stability ** stability_power
    retention = max(1.0 + alpha * impact_term + rho * stability_term, 1.0)
