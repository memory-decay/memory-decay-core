"""Impact-dependent approach with stability modulation."""
import math
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # Stability reduces approach rate (reinforced memories decay slower)
    stab_weight = params.get("stab_weight", 0.5)
    stab_protection = 1.0 + stab_weight * stability

    approach_rate = base_approach * (1.0 + approach_impact * (1.0 - impact)) / stab_protection
