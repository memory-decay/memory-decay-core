...
Based on exp_lme_0068 (best on cache_gemini2_batch, overall=0.3449).
Change: Lower reinforcement gains (direct=0.25, assoc=0.15) to improve
activation-recall correlation. When reactivation is weaker, only strongly
recalled memories stay active, making activation a sharper predictor of recall.
"""
