...
Same decay function as exp_lme_0059 (passes strict validation).
Change: lower reinforcement so recalled memories don't stay artificially active too long,
and slightly higher stability_weight to make floor more responsive to stability.
"""
