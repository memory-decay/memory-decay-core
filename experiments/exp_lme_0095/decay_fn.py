"""Hyperbolic floor decay with zero-impact bypass: concave importance floor.

Same as exp_lme_0074 but with retrieval_consolidation policy + additive formula.
Previously hyperbolic floor failed catastrophically with multiplicative (0.2654).
Maybe the additive formula changes the picture.
"""
