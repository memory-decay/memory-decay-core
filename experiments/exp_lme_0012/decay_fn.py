"""Jost's Law decay: activation-dependent rate + sigmoid floor with stability multiplier."""
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # --- Floor: sigmoid function of importance, with stability as multiplier ---
    alpha = params.get("alpha", 1.5)
    rho = params.get("stability_weight", 1.0)

    # Impact determines base floor threshold (via sigmoid)
    ...
    # Stability acts as a multiplicative boost on the floor
