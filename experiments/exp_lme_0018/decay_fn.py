"""Hyperbolic decay with sigmoid floor - alternative to Jost power law."""
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # --- Hyperbolic decay instead of Jost power law ---
    ...
    # Hyperbolic: da/dt = -lambda * a / (a + k)
    # This gives slower decay at low activations, faster approach to asymptote
    hyperbolic_k = params.get("hyperbolic_k", 0.1)

    excess = max(activation - floor, 0.0)
    decay_amount = effective_lambda * excess / (excess + hyperbolic_k)
