"""Jost's Law decay + selective prune acceleration for low-importance memories."""
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # --- Base decay rate ---
    lambda_fact = params.get("lambda_fact", 0.012)
    ...
    # Prune acceleration: low-importance memories decay faster
    prune_factor = params.get("prune_factor", 4.0)
    if importance < sigmoid_mid:
        effective_lambda *= prune_factor

    # Jost: decay rate scales with excess above floor
