"""Moderate decay with max alpha for balanced discrimination and recall."""
from memory_decay.decay import soft_floor_decay_step


def compute_decay(activation, impact, stability, mtype, params):
    lam = params.get("lambda_fact", 0.02) if mtype == "fact" else params.get("lambda_episode", 0.04)
