"""Raised universal floor: base floor + linear impact bonus."""
import math
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    base_floor = params.get("base_floor", 0.25)
    impact_floor = params.get("impact_floor_scale", 0.25)
    # Linear impact instead of sqrt — more differentiation at high impact
    floor = (base_floor + impact * impact_floor) * min(activation / 0.1, 1.0) if activation > 0 else 0.0
