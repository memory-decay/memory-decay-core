...
Same as exp_lme_0059 but with floor_max=0.40 (vs 0.45).
Zero-impact bypass is preserved so strict validation passes.
Lower floor_max should let moderate-impact items decay to lower levels,
potentially improving recall precision.
"""
