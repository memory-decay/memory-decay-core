"""Linear excess decay with sqrt(impact) floor — slower approach to floor than quadratic."""
import math
...
def compute_decay(activation, impact, stability, mtype, params):
    ...
    # Linear decay of excess: excess * (1 - lam/combined) instead of quadratic excess * (1 - lam*excess/combined)
    new_excess = excess * (1.0 - lam / combined)
