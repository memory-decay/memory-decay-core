...
Same decay function as exp_lme_0059.
Change: lambda_episode=0.045 (from 0.040) — episodes decay faster.
Hypothesis: faster episode decay may improve precision by reducing interference from
irrelevant episode memories at retrieval time.
"""
